                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-6 flex justify-end gap-2">
                        ...
                        <button
                          onClick={() =>
                            handlePreview(item.fileUrl, item.fileName)
                          }
                          className="flex h-10 items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 text-sm font-semibold text-gray-700 hover:bg-gray-100"
                        >
                          Preview
                        </button>
                        ...
                        <Link
                          ...
                          target="_blank"
                          className="flex h-10 items-center gap-2 rounded-xl bg-primary px-4 text-sm font-semibold text-white hover:opacity-90"
                        >
                          <Download size={16} />
                          Unduh
                        </Link>
